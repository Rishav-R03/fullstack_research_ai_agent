...
class ToolExecution(Base):
    ...
    tool_name = Column(String(100), nullable=False) # e.g., 'search', 'wiki_tool', 'save_research_output'
    tool_input = Column(Text) # The arguments passed to the tool
    tool_output = Column(Text) # The result returned by the tool
    ...
    error_message = Column(Text, nullable=True) # Nullable, for failed executions

    # Define relationship back to ResearchQuery
